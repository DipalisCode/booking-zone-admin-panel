...
public class TC014_EditTime_UpdateSameTime extends BaseClass
{
	...
	@Test  (testName = "testEditTime_UpdateSameBooking")
	public void testEditTime_UpdateSameBooking() throws IOException, InterruptedException 
	{
		try 
		{
			...
			//10 Am
			createBkgStepperDetailsPage.enterBookingTime(driver, UtilityClass.getDataFromEs(1, "Edit Time", "EditTime"));
			...
			createBkgStepperDetailsPage.selectPreviousTime(driver,  UtilityClass.getDataFromEs(1, "PreviousTime", "EditTime"));
	...
	public void handleException(Exception e) {
		...
		extentTest.fail("testEditTime_UpdateSameBooking test case is fail due to" + getCause);
		logger.error("testEditTime_UpdateSameBooking test case is fail due to " + getCause);
