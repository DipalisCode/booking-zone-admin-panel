...
import com.bookingzone.admin.pages.AddonsPage;
...
public class TC010EditAddonwithSavecard extends BaseClass
{
	...
	@Test (testName = "testEditAddonVaiSaveCard")
	public void testEditAddonVaiSaveCard() throws IOException, InterruptedException 
	{
		try
		{ 
...
//////////////////////////////////////////////////////////////////////
			...
			Assert.assertEquals(driver.findElement(By.xpath("(//div[@class='css-kea1wr'])[2]"))
					.isDisplayed(), true);
			extentTest.info(MarkupHelper.createLabel("Addon added verifying assertion is passed...!",
					ExtentColor.GREEN));
			System.out.println("Addon added verifying assertion is passed...!");
			logger.info("Addon added verifying assertion is passed...!");
			...
			extentTest.info(MarkupHelper.createLabel("Addon updated successfully",
					ExtentColor.ORANGE));
	...
	public void handleException(Exception e) {
		...
		extentTest.fail("testEditAddonVaiSaveCard test case is fail due to" + getCause);
		logger.error("testEditAddonVaiSaveCard test case is fail due to " + getCause);
