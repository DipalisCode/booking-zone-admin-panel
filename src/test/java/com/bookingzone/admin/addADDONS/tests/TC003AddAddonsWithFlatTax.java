 ...
 */
public class TC003AddAddonsWithFlatTax extends BaseClass {
	...
	{
		addonname=UtilityClass.getDataFromEs(3,"Addon Name", "ADD-ONS");
		tagname=UtilityClass.getDataFromEs(3, "Tag Name", "ADD-ONS");
		quantityinstock=UtilityClass.getDataFromEs(3,"Quantity In Stock", "ADD-ONS");
		baseprice=UtilityClass.getDataFromEs(3,"Base Price", "ADD-ONS");
		flattax=UtilityClass.getDataFromEs(3,"Flat Tax", "ADD-ONS");
		pertax=null;

	}

	/**
	 * Test case to add a ADD-ONS with Flat Tax.
	 *
	 * @throws IOException            If an I/O error occurs.
	 * @throws InterruptedException   If the thread is interrupted.
	 */
	@Test(testName = "testAddAddonsWithFlatTax")
	public void testAddAddonsWithFlatTax() throws IOException, InterruptedException {
		try {
	...
	private void handleException(Exception e) {
		...
		ExtentReportManager.logFail("testAddAddonsWithFlatTax test case failed due to " + getCause);
