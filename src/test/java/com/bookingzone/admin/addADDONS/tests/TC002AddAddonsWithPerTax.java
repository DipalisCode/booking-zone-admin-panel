 ...
 */
public class TC002AddAddonsWithPerTax extends BaseClass {
	...
	{
		addonname=UtilityClass.getDataFromEs(2,"Addon Name", "ADD-ONS");
		tagname=UtilityClass.getDataFromEs(2, "Tag Name", "ADD-ONS");
		quantityinstock=UtilityClass.getDataFromEs(2,"Quantity In Stock", "ADD-ONS");
		baseprice=UtilityClass.getDataFromEs(2,"Base Price", "ADD-ONS");
		flattax=null;
		pertax=UtilityClass.getDataFromEs(2,"Per Tax", "ADD-ONS");

	}

	/**
	 * Test case to add a ADD-ONS with % Tax.
	 *
	 * @throws IOException            If an I/O error occurs.
	 * @throws InterruptedException   If the thread is interrupted.
	 */
	@Test(testName = "testAddAddonsWithPerTax")
	public void testAddAddonsWithPerTax() throws IOException, InterruptedException {
		try {
	...
	private void handleException(Exception e) {
		...
		ExtentReportManager.logFail("testAddAddonsWithPerTax test case failed due to " + getCause);
