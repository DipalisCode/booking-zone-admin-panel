...
public class TC019_EditTime_FromTraffic extends A_Base_Class
{
	// Initialise_Brouser();
	// Webdriver driver

	// create object  logger class
	Logger logger = (Logger) LogManager.getLogger("TC019_EditTime_FromTraffic");
	...
	public void Update_Time_From_Traffic() throws IOException, InterruptedException 
	{
		...
		catch(Exception e) 
		{
			...
			extentTest.fail("TC019_EditTime_FromTraffic test case is fail due to" + getCause);
			logger.error("TC019_EditTime_FromTraffic test case is fail due to " + getCause);
		}
